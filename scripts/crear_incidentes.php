<?php
/**
 * Crear y cerrar incidentes correspondientes a bugs corregidos.
 * Uso: php scripts/crear_incidentes.php
 */
...
// INC-1: Age input bug (cerrado)
$db->query("INSERT INTO incidentes (titulo, descripcion, categoria, criticidad, estado, responsable, origen, resolucion, fecha_cierre) VALUES (
  ...
  'Fix: cambiado oninput por onchange. Commit 7a508ef. El validador ahora corre al salir del campo.',
  NOW()
)");
echo "INC-1 creado (age input)\n";

// INC-2: 404 rutas subdirectorio
$db->query("INSERT INTO incidentes (titulo, descripcion, categoria, criticidad, estado, responsable, origen, resolucion, fecha_cierre) VALUES (
...
echo "INC-2 creado (404 rutas)\n";

// INC-3: Home icon → /pages/BASE_URL/
$db->query("INSERT INTO incidentes (titulo, descripcion, categoria, criticidad, estado, responsable, origen, resolucion, fecha_cierre) VALUES (
...
echo "INC-3 creado (home icon)\n";

// INC-4: saveQuote error (abierto — se cierra en el próximo commit)
$db->query("INSERT INTO incidentes (titulo, descripcion, categoria, criticidad, estado, responsable, origen) VALUES (
...
echo "INC-4 creado (saveQuote - abierto)\n";
