...
<div class="space-y-6" id="quiz">
    ...
    <button onclick="calcular()" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl transition text-lg">Buscar plan de isapre</button>
    <script>
...
async function calcular() {
    ...
    try {
        ...
        cotizando = false;
        if (btn) { btn.disabled = false; btn.textContent = 'Buscar plan de isapre'; }
    }
}
